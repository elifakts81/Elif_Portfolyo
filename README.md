# Elif Aktaş | Kişisel Portfolyo

Bu proje, Yazılım Mühendisliği 1. sınıf öğrencisi olarak hazırladığım **ilk kişisel portfolyo** çalışmamdır.

## 🚀 Hakkında
Web geliştirme ve yazılım dünyasına adım atarken, öğrendiğim HTML ve CSS becerilerimi pratiğe dökmek amacıyla bu siteyi tasarladım.
...
## 📂 İletişim
İletişim için: [aktaselif903@gmail.com]
